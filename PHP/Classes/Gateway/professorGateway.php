    ...
    class ProfessorGateway {
        ...
        public function save ($data) {
            if (empty($data->id)) { //Id não localizado - Insere
                ...
                (idProfessor, nomeProfessor, escolaridade, especializacao, senhaProfessor, matriculaProfessor) VALUES ('{$id}', '{$data->nomeProfessor}', 
                '{$data->escolaridade}', '{$data->especializacao}', '{$data->senhaProfessor}', '{$data->matriculaProfessor}')"; 
            }
